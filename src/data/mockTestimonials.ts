...
export const mockTestimonials: Testimonial[] = [
  ...
  },
  {
    id: 't4',
    name: 'Priya Sharma',
    storeName: 'Sharma Stationery Mart',
    storeType: 'Stationery',
    location: 'BTM Layout, Bengaluru',
    quote:
      'I was skeptical at first, but after joining 3 groups, I am saving ₹12,000 monthly! The advance payment system gives confidence. Highly recommended.',
    savings: 12000,
    photo: '👩‍🏫',
    verified: true,
  },
  {
    id: 't5',
    name: 'Venkat Rao',
    storeName: 'City Medical Agency',
    storeType: 'Medical',
    location: 'HSR Layout, Bengaluru',
    quote:
      'Best decision for my business! The verified suppliers and automatic orders mean I spend less time on procurement and more on customers.',
    savings: 22000,
    photo: '👨‍💼',
    verified: true,
  },
